// /*
// 258p 달팽이(책의 "장마가 찾아왔다"와 문제가 오류로 인해 수정되었습니다.)
...
// int n, m; 
// double cache[1001][1002];

// double climb(int days ,int climbed) {
//   if(days >= m || climbed >= n) return climbed >= n ? 1.0 : 0.0;

//   double& result = cache[days][climbed];
//   if(result > -0.1) return cache[days][climbed];
  
//   return result = climb(days + 1, climbed + 2) * 0.75 + climb(days + 1, climbed + 1) * 0.25;
// }
